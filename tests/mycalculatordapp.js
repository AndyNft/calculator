...
describe('mycalculatordapp', () => {
  ...
  it("Adds two numbers", async function() {
    ...
    await program.rpc.calc("+", new anchor.BN(2), new anchor.BN(3), {
      accounts: {
        calculator: calculator.publicKey,
      },
    });
  ...
  it('Subtracts two numbers', async function() {
    ...
    await program.rpc.calc("-", new anchor.BN(3), new anchor.BN(2), {
      accounts: {
        calculator: calculator.publicKey,
      },
    });
  ...
  it('Divides two numbers', async function() {
    ...
    await program.rpc.calc("/", new anchor.BN(4), new anchor.BN(2), {
      accounts: {
        calculator: calculator.publicKey,
      },
    });
